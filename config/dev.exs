...
config :ecommerce_final, EcommerceFinalWeb.Endpoint,
  ...
  watchers: [
    ...
    tailwind: {Tailwind, :install_and_run, [:ecommerce_final, ~w(--watch)]}
  ]
...
config :ecommerce_final, EcommerceFinalWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/ecommerce_final_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :ecommerce_final, dev_routes: true
