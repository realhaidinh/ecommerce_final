defmodule EcommerceFinal.Accounts.Admin do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, EcommerceFinal.Repo)
  ...
  """
  def valid_password?(%EcommerceFinal.Accounts.Admin{hashed_password: hashed_password}, password)
