defmodule EcommerceFinalWeb.AdminAuth do
  ...
  def log_out_admin(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      EcommerceFinalWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_admin:
      ...
      defmodule EcommerceFinalWeb.PageLive do
        use EcommerceFinalWeb, :live_view

        on_mount {EcommerceFinalWeb.AdminAuth, :mount_current_admin}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{EcommerceFinalWeb.AdminAuth, :ensure_authenticated}] do
