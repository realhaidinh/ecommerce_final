defmodule EcommerceFinalWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EcommerceFinalWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EcommerceFinalWeb.Gettext, "errors", msg, opts)
    end
  end
