defmodule EcommerceFinalWeb.Router do
  ...
  if Application.compile_env(:ecommerce_final, :dev_routes) do
  ...
  scope "/", EcommerceFinalWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{EcommerceFinalWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", EcommerceFinalWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{EcommerceFinalWeb.UserAuth, :ensure_authenticated}] do
