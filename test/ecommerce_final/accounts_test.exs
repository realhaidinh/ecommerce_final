defmodule EcommerceFinal.AccountsTest do
  use EcommerceFinal.DataCase

  alias EcommerceFinal.Accounts

  import EcommerceFinal.AccountsFixtures
  alias EcommerceFinal.Accounts.{User, UserToken}
  ...
  import EcommerceFinal.AccountsFixtures
  alias EcommerceFinal.Accounts.{Admin, AdminToken}
